...
//		 HttpServletRequest request = (HttpServletRequest) pageContext.getRequest();    
		...
		if(getTotalPage().toString().equals("0")||getTotalPage().toString().equals("1")){//总共只有一页
			sbOut.append("<li><a href='javascript:void(0)'>首页</a></li>&nbsp;<li><a href='javascript:void(0)'>上一页</a></li>&nbsp;<li><a href='javascript:void(0)'>下一页</a></li>&nbsp;<li><a href='javascript:void(0)'>尾页</a></li>&nbsp;");
		}else if(getCurrentPage().toString().equals("1")){//当前页为第一页
			sbOut.append("<li><a href='javascript:void(0)'>首页</a></li>&nbsp;<li><a href='javascript:void(0)'>上一页</a></li>&nbsp;<li><a href='javascript:"+getClickMethod()+"("+(Integer.parseInt(getCurrentPage().toString())+1)+")'>下一页</a></li>&nbsp;<li><a href='javascript:"+getClickMethod()+"("+getTotalPage().toString()+")'>尾页</a></li>&nbsp;");
		}else if(getCurrentPage().toString().equals(getTotalPage().toString())){//当关页为最后一页
			sbOut.append("<li><a href='javascript:"+getClickMethod()+"(1)'>首页</a></li>&nbsp;<li><a href='javascript:"+getClickMethod()+"("+(Integer.parseInt(getCurrentPage().toString())-1)+")'>上一页</a></li>&nbsp;<li><a href='javascript:void(0)'>下一页</a></li>&nbsp;<li><a href='javascript:void(0)'>尾页</a></li>&nbsp;");
		}else{//显示所有链接（首页，上一页，下一页，尾页）
			sbOut.append("<li><a href='javascript:"+getClickMethod()+"(1)'>首页</a></li>&nbsp;<li><a href='javascript:"+getClickMethod()+"("+(Integer.parseInt(getCurrentPage().toString())-1)+")'>上一页</a></li>&nbsp;<li><a href='javascript:"+getClickMethod()+"("+(Integer.parseInt(getCurrentPage().toString())+1)+")'>下一页</a></li>&nbsp;<li><a href='javascript:"+getClickMethod()+"("+getTotalPage().toString()+")'>尾页</a></li>&nbsp;");
		}
...
//				sbOut.append("<option selected value='"+(i*10)+"'>"+(i*10)+"</option>");
//			}else{
...
//		}
		...
		if(pageSizeList!=null&&pageSizeList.size()>0){
			for(Integer ps:pageSizeList){
				sbOut.append("<option "+((tempPageSize==ps.intValue())?"selected":"")+" value='"+ps.intValue()+"'>"+ps.intValue()+"</option>");
			}
		}else{
	...
	public void setCurrentPage(Object currentPage) {
		try {
			this.currentPage = (Object) ExpressionEvaluatorManager.evaluate("currentIndex", currentPage.toString(), Object.class, this, pageContext);
		} catch (JspException e) {
			e.printStackTrace();
		};
	}
	...
	public void setTotalPage(Object totalPage) {
		try {
			this.totalPage = ExpressionEvaluatorManager.evaluate("maxPage", totalPage.toString(), Object.class, this, pageContext);
		} catch (JspException e) {
			e.printStackTrace();
		};
	}
...
//	}
	...
	public void setTotalCount(Object totalCount) {
		try {
			this.totalCount = (Object) ExpressionEvaluatorManager.evaluate("maxCount", totalCount.toString(), Object.class, this, pageContext);
		} catch (JspException e) {
			e.printStackTrace();
		};
	}
...
//	
	...
	public void setPageSizeList(List pageSizeList) {
